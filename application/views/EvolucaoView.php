			...
			<form id="formulario" name="formulario" action="<?php echo base_url() .'/Evolucao/' ?> " method="post" class="form-horizontal" data-parsley-validate >
		    	...
		    	<div class="row tab-content col-xs-12 col-md-12 col-sm-12">
		    		<div class="form-group col-main col-sm-2 col-xs-12">
						<label for="FFDATAINCIAL" class="sys-label col-sm-12 col-xs-12">Data Inicio:</label>
					    <div class='input-group date' >
					    	<input type='text' class="form-control" id='FFDATAINCIAL' name="FFDATAINCIAL"   autocomplete="off"/>
			        ...
			        <div class="form-group col-main col-sm-2 col-xs-12">
					    ...
					    <div class='input-group date' >
					    	<input type='text' class="form-control" id='FFDATAFINAL' name="FFDATAFINAL"   autocomplete="off"/>
					        <span class="input-group-addon">
					        	<span class="glyphicon glyphicon-calendar"></span>
					        </span>
					    </div>
