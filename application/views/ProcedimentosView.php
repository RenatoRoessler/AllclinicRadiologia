	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<form id="formulario" name="formulario" action="<?php echo base_url() .'/Procedimentos/' ?> " method="post" class="form-horizontal" data-parsley-validate >
				<div class="row sys-main-title sys-title sys-title-2">
					...
					<div class="col-md-2 col-xs-2 col-sm-2 pull-right">
		      			<button type="button" id="btnNovo" class="btn btn-info btn-sm sys-btn-search" ><i class="fa fa-file"></i> Novo Procedimentos</button>
	      			</div>	      		
		    	</div>
		    	...
		    	<div class="row tab-content col-xs-12 col-md-12 col-sm-12">
					...
					<div class="form-group col-main col-sm-3 col-xs-3">
						<label for="Descricao" class="sys-label col-sm-12 col-xs-12">Descricao:</label>
						    	...
						    	<div class="panel-body table-responsive">
						    		<table id="tableIndex" class="table table-middle table-condensed table-hover table-borderless table-striped table-bordered" style="width:100% !important;">
						    			...
						    			<tbody>
						    				...
						    				?>
						    				<tr id="<?php echo $v['CODPROCEDIMENTO']; ?>">
						    					<td><?php echo $v['CODPROCEDIMENTO']; ?></td>
						    					<td><?php echo $v['DESCRICAO']; ?></td>
						    					<td><?php echo $v['DESCATIVO']; ?></td>
						    					<td width="10"> 
						    						<a href=<?php echo base_url() .'/Procedimentos/editar/'. $v['CODPROCEDIMENTO']  ?> > 
